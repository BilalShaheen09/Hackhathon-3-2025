      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-4 py-2 bg-gray-950 hover:text-black text-white rounded-md hover:bg-gray-300 disabled:bg-gray-400"
          >
        ...
        {rateId && (
          <div className="mt-8">
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-2 bg-gray-950 text-white rounded-md hover:bg-gray-300 hover:text-black disabled:bg-gray-400"
            >
        ...
        {trackingObj && (
          <div className="mt-8">
            ...
            <Link href={`/tracking/?labelId=${trackingObj.labelId}`}>
              <button className="bg-gray-900 text-white p-3 font-bold mt-2 hover:bg-gray-600">Track Order</button>
            </Link>
          </div>
        )}
        {errors.length > 0 && (
