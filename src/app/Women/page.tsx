...
export default function WomenProducts() {
  ...
  const filteredData = products.filter(
    (product) => product.producttype?.toLowerCase() === "women"
  );
  ...
  return (
    <div className="py-10">
      <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">Women&apos;s Products List</h1>
              ...
              >
                <div className="bg-[#F5F5F5] aspect-square group p-0">
                  <Image
                    ...
                    className="w-full h-96 object-cover rounded-t-lg p-10"
                  />
                </div>
