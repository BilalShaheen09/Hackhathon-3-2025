...
export default function SkirtsAndDresses() {
  ...
  // Filter products for skirts and dresses
  const filteredData = products.filter(
    (product) =>
      product.type?.toLowerCase() === "skirt" ||
      product.type?.toLowerCase() === "dress"
  );
