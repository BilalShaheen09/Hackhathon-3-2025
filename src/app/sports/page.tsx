...
export default function Sports() {
  ...
  // Filter products for sports-related items
  const filteredData = products.filter(
    (item) =>
      item.title2.includes("Sports") ||
      item.title2.includes("Running") ||
      item.title2.includes("Basketball") ||
      item.title2.includes("Football") ||
      item.title2.includes("Training") ||
      item.title2.includes("Gym")
  );
