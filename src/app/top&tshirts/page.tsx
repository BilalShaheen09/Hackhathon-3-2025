...
export default function TopsAndTShirts() {
  ...
  // Filter products for tops and t-shirts
  const filteredData = products.filter(
    (product) =>
      product.title2.includes("Top") ||
      product.title2.includes("T-Shirt") ||
      product.title2.includes("Tank") ||
      product.title2.includes("Fitness Top") ||
      product.title2.includes("Running Top")
  );
