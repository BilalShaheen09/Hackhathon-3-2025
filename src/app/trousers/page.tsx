...
export default function TrousersAndTights() {
  ...
  // Filter products for trousers and tights
  const filteredData = products.filter(
    (product) =>
      product.type?.toLowerCase() === "trousers" ||
      product.type?.toLowerCase() === "tights"
  );
      ...
      <div className="py-10">
                ...
                >
                  <div className="bg-[#F5F5F5] aspect-square group p-0">
                    <Image
                      ...
                      className="w-full h-72 p-4 object-cover rounded-t-lg"
                    />
                  </div>
        ...
        <section className="my-10">
          ...
          <div className="space-x-2 space-y-2">
            <Button className="bg-white text-black hover:text-white rounded-full border-[1px] shadow-none">
            ...
            <Button className="bg-white text-black rounded-full hover:text-white border-[1px] shadow-none">
              New Arrivals
            </Button>
          </div>
        </section>
